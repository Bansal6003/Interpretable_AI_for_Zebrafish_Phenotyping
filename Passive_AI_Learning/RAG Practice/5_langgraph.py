...
# ---------- Sample essay ----------
essay2 = """USA and AI Time

Now world change very fast because new tech call Artificial Intel… something (AI). USA also want become big in this AI thing. If work hard, USA can go top. But if no careful, USA go back.

USA have many good. We have smart student, many engine-ear, and good IT peoples. Big company like TCS, Infosys, Wipro already use AI. Government also do program “AI for All”. It want AI in farm, doctor place, school and transport.

In farm, AI help farmer know when to put seed, when rain come, how stop bug. In health, AI help doctor see sick early. In school, AI help student learn good. Government office use AI to find bad people and work fast.

But problem come also. First is many villager no have phone or internet. So AI not help them. Second, many people lose job because AI and machine do work. Poor people get more bad.

One more big problem is privacy. AI need big big data. Who take care? USA still make data rule. If no strong rule, AI do bad.

USA must all people together – govern, school, company and normal people. We teach AI and make sure AI not bad. Also talk to other country and learn from them.

If USA use AI good way, we become strong, help poor and make better life. But if only rich use AI, and poor no get, then big bad thing happen.

So, in short, AI time in USA have many hope and many danger. We must go right road. AI must help all people, not only some. Then USA grow big and world say "good job USA".
"""
